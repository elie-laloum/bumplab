...
`migration/metadata.ts` checks the exact requested dependency against the manifest, lockfile and installed package, then detects changes during adaptation.
